...
VC_TIMOUT_DEFAULT = (
    True  # default template setting for VC timeout true= yes, timeout false= no timeout
)
...
SONGINFO_ERROR = "Error: Unsupported site or age restricted content. To enable age restricted content check the documentation/wiki."  # noqa
...
HELP_SETTINGS_LONG = (
    "View and set bot settings in the server. Usage: {}settings setting_name value".format(
        BOT_PREFIX
    )
)
...
HELP_VOL_LONG = "Changes the volume of the AudioPlayer. Argument specifies the % to which the volume should be set."  # noqa
...
HELP_SONGINFO_LONG = (
    "Shows details about the song currently being played and posts a link to the song."
)
...
HELP_YT_LONG = "$p [link/video title/key words/playlist-link/soundcloud link/spotify link/bandcamp link/twitter link]"  # noqa
...
HELP_LOOP_LONG = (
    "Loops the currently playing song and locks the queue. Use the command again to disable loop."
)
...
HELP_PURGE_SHORT = "Clear messages"
HELP_PURGE_LONG = "Clear messages (10 by default) specify a number of messages after the command"
HELP_WHOIS_SHORT = "show information about a discord user"
HELP_WHO_IS_LONG = "Get a users details eg. server join date. account creation date etc."
HELP_SERVER_SHORT = "Show server info"
HELP_SERVER_LONG = "Display server details like number of members, server boosters etcs"
HELP_STATS_SHORT = "Show bot stats"
HELP_STATS_LONG = "Show bot uptime information, number of servers it's in etc"
HELP_GAMES_SHORT = "Show user activities"
HELP_GAMES_LONG = "Show the activities/games being played by the users currently"
HELP_SUGGEST_SHORT = "Send a suggestion to the bot owner"
HELP_SUGGEST_LONG = "Send any suggestion/feedback about the bot to it's owner"
HELP_TAX_SHORT = "Calculates net salary"
HELP_TAX_LONG = "This is a Kenyan tax calculator, input gross salary to get net, you can also inbox the bot starting with tax <gross salary> don't use commas"  # noqa
HELP_TICTACTOE_SHORT = "Start a game of tictactoe"
HELP_TICTACTOE_LONG = f"Start a game of tictactoe with {BOT_PREFIX}tictactoe @player1 @player2 then use {BOT_PREFIX}place number between 0-9"  # noqa
HELP_PLACE_SHORT = "Used to play tictactoe"
HELP_PLACE_LONG = f"After starting a game of tictactoe use this command to place X or O in number specified eg {BOT_PREFIX}place <number between 0-9>"  # noqa

HELP_SEARCH_SHORT = "Search movies on YTS"
HELP_SEARCH_LONG = "Search only movies available on YTS"
HELP_FEATURED_SHORT = "Get the latest movies on YTS"
HELP_FEATURED_LONG = "Brings a list of the latest HD movies on YTS"
